...
<header class="hero-section">
    <h5><a style="color:gray" href="/ePortal/customerPortal">home</a> > <a style="color:gray" href="/ePortal/viewProductByCategory/${product.pcategory }">${product.pcategory } > </a></h5><h5 style="color:orange;">&nbsp;${product.pname}</h5>
</header>
        ...
        <div class="col-xl-12">
            <div class="card  bg-light" style="width:1000px">
                <div class="row">
                    <div class="col-xl-7">
                        <div class="p-3">
                            <div class="text-center p-4"> <img src="/ePortal/resources/img/category/${product.pimg }"id="myimage"width="400" /> </div>
                        </div>
                    </div>
                    <div class="col-xl-5">
                    <form:form action="/ePortal/buy/${product.pid}" name="addtocartform" modelAttribute="temp_cart">  
                        <div class="p-4">
                            <div class="mt-4 mb-3">
