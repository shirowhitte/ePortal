...
<div class="container" style="margin-bottom:100px;">
	<h3><center>Manage Product</center></h3>
        <div class="row my-2 mt-5">
            ...
            <div class="col-md-3">
	            <a href="addProduct">
	                <img src="/ePortal/resources/img/addproduct.png" width="300px" height="200px" class="img-fluid z-depth-3 rounded" alt="Manage Product">
	            </a>
            </div>
            <!--Grid column-->
             <!--Grid column-->
            <div class=" col-md-3">
            	<a href="viewProductVendor">
                	<img src="/ePortal/resources/img/viewproduct.png" width="300px" height="200px"class="img-fluid z-depth-3 rounded" alt="Manage Order">
            	</a>
            </div>
            <div class="col-md-3">
            	<a href="updateProduct">
                	<img src="/ePortal/resources/img/updateproduct.png" width="300px" height="200px"class="img-fluid z-depth-3 rounded" alt="Generate Report">
            	</a>
            </div>
            <!--Grid column-->
             <!--Grid column-->
            <div class="col-md-3">
            	<a href="deleteProduct">
                	<img src="/ePortal/resources/img/deleteproduct.png"width="300px" height="200px" class="img-fluid z-depth-3 rounded" alt="Generate Report">
            	</a>
            </div>
            <!--Grid column-->
        </div>
